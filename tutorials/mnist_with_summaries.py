...
def train():
	...
	with tf.name_scope('cross_entropy'):
		...
		So here we use tf.losses.sparse_softmax_cross_entropy on the raw logits outputs
	...
	for i in range(FLAGS.max_steps):
		if i % 10 == 0: # Record summaries and test-set accuracy
			summary, acc = sess.run([merged, accuaracy], feed_dict=feed_dict(False))
...
if __name__ == '__main__':
	...
	parser.add_argument('--learing_rate', type=float, default=0.001, help='Initial learning rate')
